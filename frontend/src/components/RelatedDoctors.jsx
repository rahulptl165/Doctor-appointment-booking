  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 ms:mx-10'>
      ...
      {relDoc.map((item, index)=>(
        <div onClick={()=>{navigate(`/appointment/${item._id}`); scrollTo(0, 0)}} className='border border-blue-200 rounded-xl overflow-hidden cursor-pointer hover:translate-x-[-10px] duration-300'>
